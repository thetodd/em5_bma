...
namespace flo11
{
	...
	*/
	class TriggerBMAEventCommand : public em5::Command
	{
	...
	public:
		...
		*    Constructor
		*/
		explicit TriggerBMAEventCommand(qsf::game::CommandManager* commandManager);
...
QSF_CAMP_TYPE_NONCOPYABLE(flo11::TriggerBMAEventCommand)
