...
namespace flo11
{
	...
	*/
	class InvestigateCommand : public em5::Command
	{
	...
	public:
		...
		*    Constructor
		*/
		explicit InvestigateCommand(qsf::game::CommandManager* commandManager);
...
QSF_CAMP_TYPE_NONCOPYABLE(flo11::InvestigateCommand)
